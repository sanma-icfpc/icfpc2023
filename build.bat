...
msbuild vs\ICFPC2022.sln -t:restore -p:RestorePackagesConfig=true -p:configuration=Release -p:platform=x64 || EXIT /B 1
devenv.com vs\ICFPC2022.sln /build "Release|x64" || EXIT /B 1
